...
public class FortuneTellerFrame extends JFrame {
    ...
    private void createTopPanel() {
        ...
        icon = new ImageIcon(new ImageIcon("src/853808_WP.jpg").getImage().getScaledInstance(200,220, Image.SCALE_SMOOTH) );
    ...
    private void createFortuneList() {
        fortuneList.add("Eat chicken, you'll become chicken.");
        fortuneList.add("Tap dancing will keep you on you're toes ");
        fortuneList.add("Eat sugar to have a sweeter life.");
